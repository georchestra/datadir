...
GEOR.custom = {
     ...
     */
    //METADATA_VIEW_BASE_URL: "/geonetwork/?uuid=",
     ...
     */
    DEFAULT_CSW_URL: '/geonetwork/eng/fre/csw',
     ...
     */
    GEONAMES_FILTERS: {
        username: 'geoporegion_sk', // please replace this username by yours !
     ...
     */
    EDITABLE_LAYERS: /.*geopresovregion.sk.*/i,
    ...
    SEND_MAP_TO: [{
        "name": "Mobile viewer",
        "url": "/sviewer/?wmc={context_url}",
        "qtip": "Mobile compatible viewer"
    }, {
        "name": "Desktop viewer",
        "url": "/mapfishapp/?wmc={context_url}",
        "qtip": "Desktop viewer"
    }],*/
